...
const getClienteId = (plg, event) => {
    const cliente = Object.assign({}, event.input)
    cliente.razao = cliente.razao_cliente
    cliente.email = cliente.email_cliente
    cliente.celular = cliente.celular_cliente
    cliente.fone = cliente.fone_cliente

    delete cliente.razao_cliente
    delete cliente.email_cliente
    delete cliente.celular_cliente
    delete cliente.fone_cliente
    ...
    return plg.axios({
        ...
        throw `Cliente: ${err.response.data.msg}`;
    });
};
